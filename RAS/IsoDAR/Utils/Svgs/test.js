      ...
      >
            ...
            >
              <g filter={props.componentShadow === true ? "url(#" + componentId + "elipseShadow)" : ""}>
                ...
                <path
                    id="path877"
                    d="m 30.178398,1109.7483 2.774958,-31.4476 30.28851,0.037 -2.774958,31.4479 z" />
                <path
                    id="path879"
                    d="m 63.241866,1078.3377 -30.28851,-0.037 0.7668,-8.6806 18.959301,0.045 z"/>
              </g>
            </g>


            <text className={classes.textTestValue}
           ...
           y={typeof props.valueOffsetY !== 'undefined' ? props.valueOffsetY +57.5:57.5}
            ...
            <text className={classes.textTestLabel}
...
const test = (props) => {
  ...
  return (
    <Widget svgWidget={true}  {...props} component={testComponent}  pv={props.pv} />
