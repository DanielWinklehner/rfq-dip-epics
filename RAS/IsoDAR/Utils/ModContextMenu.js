...
class ModContextMenu extends React.Component {
  constructor(props) {
    super(props);
    this.state={
  ...
  toggleYLog10Axis = ()=>{
    // this.props.testhandler({'yaxis': {'type': 'log'}});
          ...
          <ClickAwayListener onClickAway={this.props.handleClose}>
            <div>
              {pvs.length===1&&            <MenuList>
                ...
                <Divider/>
                {typeof navigator.clipboard !=='undefined'&&<MenuItem onClick={this.toggleYLog10Axis}>
                  <Typography variant="inherit">Toggle Log Axis</Typography>
                </MenuItem>}

                {typeof navigator.clipboard !=='undefined'&&<MenuItem onClick={this.openAxesMenu}>
                  <Typography variant="inherit">Set Axes</Typography>
                </MenuItem>}
...
ModContextMenu.propTypes = {
  classes: PropTypes.object.isRequired,
};

ModContextMenu.contextType=AutomationStudioContext;
export default withStyles(styles,{withTheme:true})(ModContextMenu)
