...
// PROGMEM Bytes Used:
// at least 70 * 1 * 2 + 13 * 2 * 3 = 218 bytes
...
static constexpr uint8_t NOT_A_PIN = 0;
static constexpr uint8_t NOT_A_PORT = 0;

const PROGMEM uint8_t digital_pin_to_bit_mask_PGM[]{
  // PIN IN PORT
  // -------------------------------------------
...
const PROGMEM uint8_t digital_pin_to_port_PGM[] = {
  // PORTLIST
  // -------------------------------------------
  PE, // PE 0 ** 0 ** USART0_RX
  PE, // PE 1 ** 1 ** USART0_TX
...
const uint16_t PROGMEM port_to_output_PGM[] = {
  NOT_A_PORT, // Counting started at 0.
  (uint16_t)&PORTA, (uint16_t)&PORTB, (uint16_t)&PORTC, (uint16_t)&PORTD,
  (uint16_t)&PORTE, (uint16_t)&PORTF, (uint16_t)&PORTG, (uint16_t)&PORTH,
  NOT_A_PORT, // There is not port I.
  (uint16_t)&PORTJ, (uint16_t)&PORTK, (uint16_t)&PORTL,
};

const uint16_t PROGMEM port_to_input_PGM[] = {
  NOT_A_PIN,       (uint16_t)&PINA, (uint16_t)&PINB, (uint16_t)&PINC,
  (uint16_t)&PIND, (uint16_t)&PINE, (uint16_t)&PINF, (uint16_t)&PING,
  (uint16_t)&PINH, NOT_A_PIN,       (uint16_t)&PINJ, (uint16_t)&PINK,
  (uint16_t)&PINL,
};

const uint16_t PROGMEM port_to_ddr_PGM[] = {
  NOT_A_PORT,      (uint16_t)&DDRA, (uint16_t)&DDRB, (uint16_t)&DDRC,
  (uint16_t)&DDRD, (uint16_t)&DDRE, (uint16_t)&DDRF, (uint16_t)&DDRG,
  (uint16_t)&DDRH, NOT_A_PORT,      (uint16_t)&DDRJ, (uint16_t)&DDRK,
  (uint16_t)&DDRL,
};
